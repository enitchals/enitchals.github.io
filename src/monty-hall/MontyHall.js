...
// RESET THE SIMULATION
  ...
  render() {
    return (
      ...
      <div className="MHApp">
      <div className="MHSimulation column">
        {(this.state.intro)
          ? null
          : <div className="MHdoor-row box">
        ...
        <div className="MHText box">
          <div className="MHtitle">Monty Hall Simulator</div>
          ...
          {(this.state.firstPick !== null && this.state.secondPick === null)
            ?<button className="MHbuttons" onClick={this.stayDoor}>STAY</button>
            : ''}
          {(this.state.firstPick !== null && this.state.secondPick === null)
            ?<button className="MHbuttons" onClick={this.switchDoor}>SWAP</button>
            : ''}
          {(this.state.firstPick !== null && this.state.secondPick !== null)
            ?<button className="MHbuttons" onClick={this.reset}>TRY AGAIN</button>
            : ''}
          </div>
        </div>
      </div>
      <div className="MHresults box">
        <img className="MHgoatimg" src={GOAT}/>
        <div className="MHresults-table">
          <h3>RESULTS:</h3>
          <tr>
            <th>&nbsp;</th>
            <th>stay</th>
