...
export default class Door extends Component {
    ...
    render(props) {
        ...
        return(
            <div className="MHdoor">
                {(this.props.revealDoor == this.props.door)
                    ? <img className="MHdoorWidth" src={goat}/>
                    : (this.props.secondPick === null)
                        ? <img className="MHdoorWidth" src={this.props.doorImg} onClick={() => this.props.firstDoorPick(this.props.door)}/>
                        : (this.props.prizeDoor == this.props.door)
                            ? <img className="MHdoorWidth" src={prize}/>
                            : <img className="MHdoorWidth" src={goat}/>
                            }
            </div>
        )
